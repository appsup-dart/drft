...
Represents a Firebase project. Projects can be read but creation and deletion must be done through the Firebase Console or Google Cloud Console.
...
- ⚠️ Update: Limited (verifies project exists)
