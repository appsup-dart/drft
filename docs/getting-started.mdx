...
This guide will help you get started with DRFT and create your first infrastructure stack.
...
1. **Define** your desired infrastructure in code
...
Check that your resource definitions match the actual infrastructure. Use `refresh()` to sync state.
